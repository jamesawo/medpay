...
const routes: Routes = [
    {
        ...
        children: [
            { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
            {
                ...
                data: { title: 'Welcome', titleI18n: 'dashboard' },
            },
            {
                path: 'exception',
                loadChildren: () =>
            ...
            },
            {
                ...
                loadChildren: () =>
                    import('./global-settings/global-settings.module').then(
            ...
            },
            {
                path: 'agent',
                loadChildren: () =>
                    import('./agents/agents.module').then(
                        (m) => m.AgentsModule
                    ),
            },
            {
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                data: { title: 'Registration result', titleI18n: 'pro-register-result' },
            },
            {
                path: 'lock',
                component: UserLockComponent,
                data: { title: 'Lock', titleI18n: 'lock' },
            },
        ],
    },
    //
