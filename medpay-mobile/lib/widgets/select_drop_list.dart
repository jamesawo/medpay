...
class SelectDropList extends StatefulWidget {
  ...
  const SelectDropList(this.itemSelected, this.dropListModel, this.onOptionSelected, {Key? key}) : super(key: key);
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  border: Border(top: BorderSide(color: ThemeColorStyle.appGray20, width: 1)),
                ),
                child: Text(item.title,
                    style: const TextStyle(color: ThemeColorStyle.appBlue, fontWeight: FontWeight.w400, fontSize: 14),
                    maxLines: 3,
