...
class SettingTermsOfServiceScreen extends StatelessWidget {
  const SettingTermsOfServiceScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            const AppTopTitle(title: 'Terms of Service'),
            Container(
              width: 250,
              height: 300,
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/terms_of_service.png'),
                  fit: BoxFit.contain,
                ),
              ),
            ),
