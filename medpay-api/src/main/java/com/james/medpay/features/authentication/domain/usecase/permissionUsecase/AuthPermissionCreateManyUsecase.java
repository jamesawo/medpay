...
public class AuthPermissionCreateManyUsecase implements UsecaseContract<Optional<Boolean>, Set<IPermission>> {
	private final IAuthPermissionRepository repository;

	@Override
	public Optional<Boolean> execute( Set<IPermission> permissions ) {
