...
public class TransactionGetPayerDetailByTrRefUsecase implements UsecaseContract<Optional<ITransactionPayerDetail>, String> {
	private final ITransactionPayerDetailRepository repository;

	@Override
	public Optional<ITransactionPayerDetail> execute( String reference ) {
		return repository.getPayerDetailByTransactionReference( reference );
	}
