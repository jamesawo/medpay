...
public class AuthGetRoleStatusByIdUsecase implements UsecaseContract<Optional<Boolean>, Long> {
	private final IAuthRoleRepository repository;

	@Override
	public Optional<Boolean> execute( Long aLong ) {
		return repository.getStatusId( aLong );
	}
}
