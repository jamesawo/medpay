...
public class UserSetAddressVerifiedStatusUsecase implements UsecaseContract<Optional<Boolean>, Param<Boolean>> {
	...
	public Optional<Boolean> execute( Param<Boolean> param ) {
		return repository.setAddressIsVerifiedStatusByUserId( param.getId(), param.getModel() );
	}
}
