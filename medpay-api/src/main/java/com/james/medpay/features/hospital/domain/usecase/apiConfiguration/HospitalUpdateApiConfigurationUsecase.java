...
import com.james.medpay.features.hospital.data.repositoryImp.HospitalApiConfigRepositoryImpl;
...
@UseCase
public class HospitalUpdateApiConfigurationUsecase implements UsecaseContract<
		Optional<HospitalApiConfiguration>, Param<HospitalApiConfiguration>> {


	private final IHospitalApiConfigRepository repository;

	public HospitalUpdateApiConfigurationUsecase( HospitalApiConfigRepositoryImpl implementation ) {
	...
	public Optional<HospitalApiConfiguration> execute( Param<HospitalApiConfiguration> params ) {
		return this.repository.updateHospitalApiConfiguration( params );
	}
}
