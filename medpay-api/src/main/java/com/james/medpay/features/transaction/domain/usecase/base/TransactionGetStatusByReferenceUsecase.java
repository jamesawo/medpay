...
public class TransactionGetStatusByReferenceUsecase implements UsecaseContract<Optional<TransactionStatusEnum>, String> {
	private final ITransactionEntityRepository repository;

	@Override
	public Optional<TransactionStatusEnum> execute( String reference ) {
		return repository.getStatusByReference( reference );
	}
}
